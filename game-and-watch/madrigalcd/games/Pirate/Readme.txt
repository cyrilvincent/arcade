Product:	Pirate (VTech, Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	23rd November, 2007
First release:	10th December, 2007
...
* Instructions:
  - Pirates continuously climb up to embark your ship from three paths,
    to steal your gold.
  - Move the captain to prevent pirates from reaching the deck.
  - When a pirate successfully reaches the deck, a chance is missed.
  - Five misses and game ends.
* Score:
  - 1 point is scored each time a pirate is hit.
