Product:	Hot Line (VTech, Mini Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	15th April,    2014
First release:	21st April,    2014
...
* Instructions:
  - A clerk has the task to answer phonecalls very quickly.
  - Move the clerk's hand left and right to answer phonecalls.
  - When a phonecall is not answered, a chance is missed.
  - The secretary appears occasionally, waiting for the clerk to sign
    a few documents (game B only).
  - Three misses and game ends.
* Score:
  - 10 points are scored each time a phonecall is answered.
  - 50 points are scored each time a document is signed.
...
A) by MOUSE and TOUCH SCREEN
   ...
   Left/Right buttons	Move the hand left/right
...
B) by KEYBOARD
   ...
   Arrow keys (*)	Move the hand left/right
