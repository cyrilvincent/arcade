Product:	Chicky Woggy (VTech, Electronic Tini-Arcade) Simulator
Version: 	5.00 (Standard 5, complete rewrite)
Started:	 3rd March,    2008
First release:	18th December, 2009
...
The author is in no way affiliated with VTech.
"Chicky Woggy"			(C) VTech, 1982
"Electronic Tini-Arcade"	(C) VTech
...
* Press Select button to select game A (easy) or game B (hard).
* Press Start button to play.
* Hiscore is displayed while "game start" tune plays.
* Instructions:
  - Help Chicky Woggy fill the labyrinth with eggs, while wolves chase her.
  - Chicky Woggy can move across bridges, subways and tunnels to escape
    wolves.
  - As soon as Chicky Woggy eats magic worms, she can chase and defeat wolves for
    a short period of time.
  - When the labyrinth is full of eggs, Chicky Woggy moves to a new empty
    labyrinth.
  - Three misses and game ends.
* Score:
  - 10 points are scored each time an egg is laid.
  - 50 points are scored each time a worm is eaten.
  - 200 to 400 points are scored each time a wolf is defeated.
* Bonus life is awarded at 2000 points.
* Maximum displayed score is 99990.
...
A) by MOUSE and TOUCH SCREEN
   ...
   Select Game A/B	Select game A (easy) or game B (hard)
   Start		Start game (hold to view hiscore)

   Button overlays (*)	Move the main character

B) by KEYBOARD

   1 (**)        	Turn on/off the game
   2 (**)		Select game A (easy) or game B (hard)
   3 (**)		Start game (hold to view hiscore)
...
(**) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
Jaro Gielens	for providing scans from the English instructions manual
