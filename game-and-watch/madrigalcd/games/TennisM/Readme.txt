Product:	Tennis Menace (VTech, Mini Time & Fun) Simulator
Version:	5.00 (Standard 5, final)
Started:	25th July,   2022
First release:	1st  August, 2022
...
on handheld simulators, and download a wide selection of over 60 games,
...
* Instructions:
  - Train tennis by playing with your coach.
  - Move the player left and right to get all balls.
  - When a ball falls on the ground, a chance is missed.
  - Three misses and game ends.
* Score:
  - 10 points are scored each time a ball is hit.
...
A) by MOUSE and TOUCH SCREEN
   ...
   Left/Right buttons	Move the tennis player left/right
...
B) by KEYBOARD
   ...
   Arrow keys (*)	Move the tennis player left/right
...
(*) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
Véronique Spisso	for providing scans of the original game and instructions manual
