Product:	Cessate il Fuoco (VTech, Mini Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	31st October,  2010
First release:	20th December, 2010
...
"Cessate il Fuoco"	(C) VTech, 1984
"Time & Fun"    	(C) VTech
"Heathcliff"		(C) Mc Naught, 1983
...
* Instructions:
  - Help Heathcliff the cat to prevent Sonja's flowers from being burned by
    flaming sticks thrown by an enemy cat.
  - Spike the dog watches from behind the fence.
  - Misses: one miss per burnt flower.
  - Three misses and game ends.
* Score:
  - 10 points are awarded when Heathcliff successfully extinguishes a flame.
* All flames are cleared at every 1000 points.
* Maximum displayed score is 9999.
...
A) by MOUSE and TOUCH SCREEN
   ...
   Left/Right buttons	Move Heathcliff left/right
   Shoot (left/right)	Spray water
...
B) by KEYBOARD
   ...
   Arrow keys (*)	Move Heathcliff left/right
   Control/Alt keys (*)	Spray water
...
(*) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
Alessandro Bertolotti	for providing scans from the game box and manual
