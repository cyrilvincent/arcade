Product:	Escape (VTech, Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	 1st November, 2009
First release:	13th November, 2009
...
* Instructions:
  - Manipulate the motion of the prisoner so as to avoid being caught by the
    guards appearing in the upper and lower rows, and to escape through the
    gate as soon as it's open.
  - When the prisoner is spotted by a guard, he will be caught, meaning a
    miss.
  - Five misses and game ends.
* Score:
  - 1 point is awarded when a prisoner successfully leaves the jail.
