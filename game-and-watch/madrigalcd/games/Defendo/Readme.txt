Product:	Defendo (VTech, Explorer Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	 5th December, 2007
First release:	24th December, 2007
...
* Instructions:
  - Enemy soldiers continuously move towards your camp from three paths,
    trying to steal your Army's gold.
  - Move the brave soldier to prevent soldiers from reaching the camp.
  - When an enemy successfully reaches the camp, a chance is missed.
  - Five misses and game ends.
* Score:
  - 1 point is scored each time an enemy soldier is hit.
