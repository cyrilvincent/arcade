Product:	Roller Coaster (VTech, Explorer Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	 6th November, 2007
First release:	19th November, 2007
...
3) chronometer: same as above
                                 ...
                                 HOW TO PLAY
                                 -----------
* Press Time button to shift through time, alarm, chrono and date modes.
* Press Game A button to play game A (easy).
* Press Game B button to play game B (hard).
* Instructions:
  - Rollercoaster needs maintenance: there are three holes on the railway.
  - Move a busy worker around the rails to fill holes and prevent cars from
    falling.
  - When a car falls into a hole, one miss is scored.
  - Five misses and game ends.
* Score:
  - 1 point is scored for each safe car.
