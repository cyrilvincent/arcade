Product:	Egg (Nintendo, Game & Watch Wide Screen) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	 2nd September, 2001
First release:	17th September, 2001
...
* Instructions:
  - Chickens lay eggs. Control the wolf so that he catches them in his cap.
  - When the wolf drops an egg, one miss is scored.
  - The cock appears/disappears at every five seconds.
  - When the cock appears while egg falls, half miss is scored (miss mark
    blinks).
  - Three full misses and game is over
* Score:
  - 1 point per caught egg.
* At 200 and 500 points, if there are one or more misses, fanfare sounds and
...
B) by KEYBOARD
   ...
   Q (*)		Move the main character up-left
   P (*)		Move the main character up-right
   A (*)		Move the main character down-left
   L (*)		Move the main character down-right
...
(*) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
David Calandra		for providing scans of the game for the "S3" simulator
David Gschmeidler,
Gerhard Meyer		for providing scans of the game for the "S4" simulator
