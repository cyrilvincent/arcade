Product:	Sleep Walker (VTech, Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	16th October,  2007
First release:	12th November, 2007
...
* Instructions:
  - Move a busy man in pyjama around the house to save sleepwalkers.
  - When a sleepwalker gets awaken, one miss is scored.
  - Five misses and game ends.
* Score:
  - 1 point is scored for each safe sleepwalker.
...
(*) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
Dot Dorrington	for providing scans from the English instructions manual
