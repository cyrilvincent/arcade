Product:	Engine Room (VTech, Explorer Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	 6th January,  2008
First release:	21st January,  2008
...
* Instructions:
  - The love boat engine needs coal, or it'll stop cruising across the ocean.
  - Move a busy worker in order to throw coal continously into the furnace.
  - When a lot of coal is not supplied, a chance is missed.
  - A mate appears occasionally, bringing some tea to our character (game B
    only).
  - Three misses and game ends.
* Score:
  - 10 points are scored each time a lot of coal is thrown into the furnace.
  - 50 points are scored each time the worker drinks some tea.
