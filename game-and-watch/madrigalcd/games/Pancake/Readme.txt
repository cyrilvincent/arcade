Product:	Pancake (VTech, Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	15th November, 2007
First release:	26th November, 2007
...
* Instructions:
  - Move a busy waiter around the restaurant to bring pancakes from cook
    to a hungry customer.
  - When a pancake falls to ground, one miss is scored.
  - Five misses and game ends.
* Score:
  - 1 point is scored for each pancake successfuly delivered.
