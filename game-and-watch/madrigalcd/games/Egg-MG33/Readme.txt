Product:	Frog Boaster (Elektronika) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	24th October,  2009
First release:	 6th November, 2009 (MADrigal's Simulators 10th anniversary)
...
* Instructions:
  - Move a frog to catch butterflies.
  - When a butterfly escapes, a miss is scored.
  - The chicken appears/disappears at every five seconds.
  - When the cock appears while butterfly escapes, half miss is scored
    (miss mark blinks).
  - Three full misses and game is over.
* Score:
  - 1 point is scored for each butterfly caught by frog.
