Product:	Bomb Fight (VTech, Mini Time & Fun) Simulator
Version:	5.00 (Standard 5, complete rewrite)
Started:	27th April,    2011
First release:	16th May,      2011
...
* Instructions:
  - An angry lion is throwing bombs to a peaceful elephant.
  - Playing the elephant, you have to spit water to bombs to defuse them
    before they explode.
  - Misses: one miss per exploded bomb.
  - Three misses and game ends.
* Score:
  - 10 points are awarded when the elephant successfully defuses a bomb.
* All bombs are cleared at every 1000 points.
...
A) by MOUSE and TOUCH SCREEN
   ...
   Left/Right buttons	Move the main character left/right
   Shoot (left/right)	Shoot
...
B) by KEYBOARD
   ...
   Arrow keys (*)	Move the main character left/right
   Control/Alt keys (*)	Shoot
...
(*) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
Joao Machado Accorsi	for providing the backdrop/wallpaper artwork
