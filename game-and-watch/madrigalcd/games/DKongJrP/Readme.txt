Product:	Donkey Kong Jr. (Nintendo, Game & Watch Panorama Screen) Simulator
Version: 	5.01 (Standard 5, graphics improvements)
Started:	17th March, 2001
First release:	 3rd April, 2001
Latest update:	14th March, 2022
...
"Donkey Kong Jr."	(C) Nintendo Co. Ltd., 1983
...
* Instructions:
  - Donkey Kong has been captured and chained by Mario.
  - Donkey Kong Jr. goes to papa's rescue with key he needs to open the locks
    on the chains.
  - Junior is attacked by fierce birds.
  - He uses umbrellas to leap from heights, and balloons to get up there,
    opening the locks on the way.
  - When he opens all 4 locks, papa is free.
  - Each time he opens one lock, he must go back to SATRT to retrieve the key,
    then sets out again is lost.
  - With three misses game ends.
* Score:
  -  1 point when Junior jumps to umbrella or balloon.
  -  2 to 10 points when Junior hits fierce bird with coconut.
  - 10 points when Junior opens one lock.
  - 10 points (extra bonus) when Junior opens all four locks.
* When score reaches 300 points and there are one or two misses, all the misses
  are cleared with fanfare. If there are no misses when a 300 score is reached,
  game goes into "CHANCE TIME". Score flashes and all the points are awarded at
  double value until a miss is scored.
* Maximum displayed score is 999 points. At 999 points score resets and game
...
A) by MOUSE and TOUCH SCREEN
   ...
   Time 		Time (hold to view alarm time)
   ACL			Reset the game

   Button overlays (*)	Move Junior
   Jump button          Jump
...
B) by KEYBOARD
   ...
   3 (**)		Time (hold to view alarm time)
   5 (**)		Open the game/Reset the game

   Arrow keys (**)	Move Junior
   Control key (**) 	Jump
...
(**) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
René van Egmond	for providing scans and photos of the original game
Anthony Lavenu	for providing scans of English instructions manual
Simone Congiu	for additional Delphi programming
Itizso		for providing 3D animation of the directional cross

Beta-testers	Robert Kacsich, Andy Cole, Guyfawkes, Marco Lago, David Calandra,
		Roberto Mayrhofer, Carlos Botella
