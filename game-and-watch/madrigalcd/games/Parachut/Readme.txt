Product:	Parachute (Nintendo, Game & Watch Wide Screen) Simulator
Version:	5.02 (Standard 5, more accuracy)
Started:	10th September, 2007
First release:	15th October,   2007
Latest update:	14th January,   2021 (my birthday!)
...
* Score:
  - 1 point is scored for each skydiver caught by the lifeboat.
...
A) by MOUSE and TOUCH SCREEN
   ...
   Left/Right buttons	Move the lifeboat left/right
...
B) by KEYBOARD
   ...
   Arrow keys (*)	Move the lifeboat left/right
...
(*) you can redefine the keys from the panel featured in the popup menu
                                   ...
                                   THANKS TO
                                   ---------
Davide Calabrò	for providing scans from the original instructions manual
D. Yen		for bug reporting
Koby Goldberg	for invaluable help and input about the game accuracy
