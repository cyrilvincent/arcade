Product:	Snoopy (Nintendo, Game & Watch Table Top) Simulator
Version: 	5.01 (Standard 5, graphic improvements)
Started:	13th November, 2000
First release:	17th November, 2000
...
A) by MOUSE and TOUCH SCREEN
   ...
   Button overlays (*)	Move Snoopy left/right
   Hit button           Hammer
...
B) by KEYBOARD
   ...
   Arrow keys (**)	Move Snoopy left/right
   Control key (**)   	Hammer
...
René van Egmond	for providing scans of the English instructions manual
